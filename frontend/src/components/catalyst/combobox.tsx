        ...
        {({ open }) => (
          <React.Fragment>
            <div className='relative'>
              <Headless.ComboboxButton className={'h-full w-full'}>
              ...
              {!search && (
                ...
                >
                  ...
                  <Headless.ComboboxButton className='group absolute inset-y-0 right-0 flex w-full items-center justify-end px-2.5'>
                    <ChevronDownIcon
                      className={clsx(
                        'size-4 transform text-zinc-950/60 dark:text-white/60 transition-all group-data-[hover]:fill-zinc-950 dark:group-data-[hover]:fill-white',
