...
export namespace settings {
  export class WalletConfig {
    ...
    constructor(source: any = {}) {
      if ('string' === typeof source) source = JSON.parse(source);
      this.nwcUrl = source['nwcUrl'];
      this.connectorName = source['connectorName'];
      this.connectorType = source['connectorType'];
      this.lnbitsInstanceUrl = source['lnbitsInstanceUrl'];
      this.lnbitsAdminKey = source['lnbitsAdminKey'];
    }
  }
  export class Settings {
    ...
    constructor(source: any = {}) {
      ...
      this.wallet_config = this.convertValues(
